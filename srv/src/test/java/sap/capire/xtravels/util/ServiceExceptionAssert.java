...
public class ServiceExceptionAssert extends ThrowableTypeAssert<ServiceException>{
    ...
    @Override
    protected ThrowableAssertAlternative<ServiceException> buildThrowableTypeAssert(ServiceException throwable) {
        return new ServiceExceptionAssertAlternative(throwable);
    }

    public static class ServiceExceptionAssertAlternative extends ThrowableAssertAlternative<ServiceException> {
        ...
        public ServiceExceptionAssertAlternative isBadRequest() {
            assertThat(actual.getErrorStatus().getHttpStatus()).isEqualTo(ErrorStatuses.BAD_REQUEST.getHttpStatus());
